...
public interface MarcaService {
	...
	/*
	 * Es una forma mas clara y segura de represetanr un valor null, con esto un
	...
	/*
	 * retorna el objeto de tipo Marca, resive la Marca antes de que se guarda y
	 * despues retorna la marca guardada
	 */
